...
if (isset($_POST['submit_word'])) {
    ...
    switch ($dataset) {
        case "atis":
            ...
            echo create_sense_table("Atis", $atis, $word, $search_type);
            break;
        case "boun":
            $boun = new AnnotatedCorpus("../Boun/Turkish-Phrase");
            echo create_sense_table("Boun", $boun, $word, $search_type);
            break;
        case "tourism":
            $tourism = new AnnotatedCorpus("../Etstur/Turkish-Phrase");
            echo create_sense_table("Tourism", $tourism, $word, $search_type);
            break;
        case "gb":
            $gb = new AnnotatedCorpus("../Gb/Turkish-Phrase");
            echo create_sense_table("Gb", $gb, $word, $search_type);
            break;
        case "imst":
            $imst = new AnnotatedCorpus("../Imst/Turkish-Phrase");
            echo create_sense_table("Imst", $imst, $word, $search_type);
            break;
        case "kenet":
            $kenet = new AnnotatedCorpus("../Kenet-Examples/Turkish-Phrase");
            echo create_sense_table("Kenet", $kenet, $word, $search_type);
            break;
        case "penn":
            $penn15 = new AnnotatedCorpus("../Penn-Treebank/Turkish-Phrase");
            $penn20 = new AnnotatedCorpus("../Penn-Treebank-20/Turkish-Phrase");
            echo create_sense_table("Penn-Treebank-15", $penn15, $word, $search_type);
            echo create_sense_table("Penn-Treebank-20", $penn20, $word, $search_type);
            break;
        case "pud":
            $pud = new AnnotatedCorpus("../Pud/Turkish-Phrase");
            echo create_sense_table("Pud", $pud, $word, $search_type);
            break;
    }
}
?>
