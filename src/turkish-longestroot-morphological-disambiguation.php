...
<head>
    <meta charset="UTF-8">
    <title>Turkish Morphological Disambiguation</title>
</head>
<body>
<?php
...
$disambiguator = new LongestRootFirstDisambiguation();
include 'functions.php';
?>
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <label for="sentence">Sentence: (Ayşe yemeğini ye .)</label>
...
if (isset($_POST['submit_morphological_analysis'])) {
    ...
    echo create_morphological_disambiguation_table($disambiguator, $fsm, $sentence);
}
?>
</body>
</html>